	...
	return (
		<div className="relative w-screen h-screen">
			<Image
				...
				fill
				priority
				className="absoulte left-0 top-0 z-10 w-screen h-screen opacity-40"
			/>
				...
				<SignUp
					appearance={{
						...
						elements: {
							// Container size
							cardBox:
								"w-[550px] shadow-md flex justify-center z-20",
							card: "w-[550px] border",
							...
							formFieldLabel:
								"text-sm font-medium text-[#004f8a]",
